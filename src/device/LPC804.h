...
/*! @name LUT_INP_INP_MUX - LUT0 input 0 MUX..LUT25 input 4 MUX */
/*! @{ */
#define PLU_LUT_INP_INP_MUX_LUTn_INPx_MASK       (0x3FU)
#define PLU_LUT_INP_INP_MUX_LUTn_INPx_SHIFT      (0U)
 ...
 *  0b100011..state(3).
 */
#define PLU_LUT_INP_INP_MUX_LUTn_INPx(x)         (((uint32_t)(((uint32_t)(x)) << PLU_LUT_INP_INP_MUX_LUTn_INPx_SHIFT)) & PLU_LUT_INP_INP_MUX_LUTn_INPx_MASK)
/*! @} */

/* The count of PLU_LUT_INP_INP_MUX */
#define PLU_LUT_INP_INP_MUX_COUNT                (26U)

/* The count of PLU_LUT_INP_INP_MUX */
#define PLU_LUT_INP_INP_MUX_COUNT2               (5U)

/*! @name LUT_T_LUT_TRUTH - Specifies the Truth Table contents for LUT0..Specifies the Truth Table contents for LUT25 */
/*! @{ */
#define PLU_LUT_T_LUT_TRUTH_LUTn_TRUTH_MASK      (0xFFFFFFFFU)
#define PLU_LUT_T_LUT_TRUTH_LUTn_TRUTH_SHIFT     (0U)
/*! LUTn_TRUTH - Specifies the Truth Table contents for LUT25..
 */
#define PLU_LUT_T_LUT_TRUTH_LUTn_TRUTH(x)        (((uint32_t)(((uint32_t)(x)) << PLU_LUT_T_LUT_TRUTH_LUTn_TRUTH_SHIFT)) & PLU_LUT_T_LUT_TRUTH_LUTn_TRUTH_MASK)
/*! @} */
...
#define SWM_PINASSIGN2_SPI0_SCK_IO_SHIFT         (1U)
